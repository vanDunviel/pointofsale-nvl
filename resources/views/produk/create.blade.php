            ...
            <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('produk.index') }}"
                        class="px-4 py-2 rounded bg-red-600 hover:bg-red-700 text-white font-semibold">Batal</a>
                    <button type="submit"
                        class="px-4 py-2 rounded bg-blue-600 hover:bg-blue-700 text-white font-semibold">Simpan</button>
                </div>
            </form>
        </div>
    </div>
